...
class PaginatedIndividualWatchlistScreeningHitListResponse(BaseModel):
    ...
    @classmethod
    def parse_obj(cls, data: Any) -> "PaginatedIndividualWatchlistScreeningHitListResponse":
        """Parse a dict into the object. Takes same keyword arguments as pydantic.BaseModel.parse_obj"""
        return super().parse_obj(data)

    @classmethod
    def parse_raw(cls, b: Union[bytes, str], **kwargs: Any) -> "PaginatedIndividualWatchlistScreeningHitListResponse":
